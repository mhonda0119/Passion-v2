...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, IR_L_Pin|IR_FL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PUSH_IN_1_Pin SW_POWER_Pin PUSH_IN_3_Pin MOTOR_L_CCW_Pin
                           MOTOR_L_CW_Pin */
  GPIO_InitStruct.Pin = PUSH_IN_1_Pin|SW_POWER_Pin|PUSH_IN_3_Pin|MOTOR_L_CCW_Pin
                          |MOTOR_L_CW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : LED_4_Pin LED_6_Pin LED_5_Pin LED_7_Pin */
  GPIO_InitStruct.Pin = LED_4_Pin|LED_6_Pin|LED_5_Pin|LED_7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
